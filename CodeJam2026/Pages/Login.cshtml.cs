...
public class IndexModel : PageModel
{
    ...
    public IndexModel(IConfiguration configuration, ITeamSessionStore teamSessionStore)
    {
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        else
        {
            ...
            _teamSessionStore.SetActiveSession(SelectedUser, sessionId);

            claims.Add(new Claim("TeamSessionId", sessionId));
        }
