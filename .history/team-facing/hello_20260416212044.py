...
def compile_button(data):
    ...
    if current_language == ".java":
        ...
        subprocess.run(["C:\\MinGW\\bin\\g++.exe", "C:\\Users\\andre\\PycharmProjects\\code-jam\\team-facing\\submissions\\submission.cpp", "-o", "C:\\Users\\andre\\PycharmProjects\\code-jam\\team-facing\\submissions\\submission.exe"], capture_output=True, text=True)
