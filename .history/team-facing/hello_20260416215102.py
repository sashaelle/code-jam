...
def compile_button(data):
    ...
    if current_language == ".java":
        ...
        submitted_file_path = "C:\\Users\\andre\\PycharmProjects\\code-jam\\team-facing\\submissions\\submission.cpp"
        cmd = ["C:\\MinGW\\bin\\g++.exe", submitted_file_path, "-o", 
            "C:\\Users\\andre\\PycharmProjects\\code-jam\\team-facing\\submissions\\submission"]
        print("Running:", cmd)
        result = subprocess.run(cmd, capture_output=True, text=True, shell=True)
        print("File path:", submitted_file_path)
        print("File exists:", os.path.exists(submitted_file_path))
